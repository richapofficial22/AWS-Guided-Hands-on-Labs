...
- Amazon services used : Amazon Simple Storage Service
...
- What I learned: Difference between public access block settings, bucket policies, and
...
- What I learned: Event-driven architecture pattern — EventBridge routes EC2 lifecycle events
...
- What I learned: Relationship between EC2 and EBS (compute vs persistent storage). AMI as a
point-in-time snapshot used for backup or to launch identical instances. Importance of
cleanup to avoid ongoing AWS charges.
